...
public class GearChange {
  ...
  static class TelemetryJsonParser implements FlatMapFunction<ObjectNode, Tuple3<String, Float, Integer>> {
    ...
    public void flatMap(ObjectNode jsonTelemetry, Collector<Tuple3<String, Float, Integer>> out) throws Exception {
      ...
      int car = jsonTelemetry.get("Car").asInt();
      Float gear = jsonTelemetry.get("telemetry").get("Gear").floatValue();

      if (car == Integer.parseInt(CarNumberFilter)) {
  ...
  static class GearReducer implements ReduceFunction<Tuple3<String, Float, Integer>> {
    ...
    public Tuple3<String, Float, Integer> reduce(Tuple3<String, Float, Integer> value1,
      ...
      if (!value1.f1.equals(value2.f1)) {
        value1.f2 = value1.f2 + 1;
      }

      return new Tuple3<>(value1.f0, value2.f1, value1.f2);
    }
  }

  static class GearMap implements FlatMapFunction<Tuple3<String, Float, Integer>, Tuple2<String, Integer>> {
    @Override
    public void flatMap(Tuple3<String, Float, Integer> carInfo, Collector<Tuple2<String, Integer>> out)
        throws Exception {
